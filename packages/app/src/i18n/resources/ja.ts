...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    remoteSandbox: {
      ...
      description:
        "Run workspaces in disposable cloud sandboxes. Keys are stored on this daemon and never shown back to any client.",
      provider: "Provider",
      daytonaApiKey: "Daytona API key",
      daytonaApiUrl: "Daytona API URL",
      tailscaleAuthKey: "Tailscale auth key",
      tailscaleAuthKeyHint: "Reusable + ephemeral key from your own tailnet.",
      tailscaleTag: "Tailscale tag",
      image: "Sandbox image",
      imageHint: "Snapshot/image ref the box boots from.",
      secretConfigured: "•••••••• configured — type to replace",
      secretNotSet: "not set",
      save: "Save",
      saving: "Saving…",
      saved: "Saved",
      savedBody: "Remote sandbox settings updated.",
