...
| [docs/remote-sandbox-spike.md](docs/remote-sandbox-spike.md)       | Spike: run the daemon in a disposable Daytona sandbox and drive it with the SDK — the four risks it proves, deliberate corners  |
| [docs/remote-workspace-plan.md](docs/remote-workspace-plan.md)     | Plan: turn the sandbox spike into a "Remote" workspace feature — capability gating, provisioning RPC, Tailscale, unified app UX |
